...
The categories should reflect the user's actual top spending categories where possible. Always include at least: Housing, Groceries, Transport, Savings, and any significant debt payments. All amounts should sum to approximately monthlyIncome. Amounts are monthly dollar figures.
...
export async function POST(request: NextRequest) {
  ...
  const userMessage = `Here is my financial profile:
