...
// ─── Analytics Holdings (for portfolio analytics page) ───────────────────────

export const mockAnalyticsHoldings = [
  { id: 'm1', accountId: 'acc1', userId: 'u1', ticker: 'VTI',  name: 'Vanguard Total Stock Market ETF',      assetClass: 'etf',          sector: 'Broad Market',           geography: 'US',                    quantity: 285,  costBasis: 195.20, currentPrice: 252.40, currentValue: 71934.00, beta: 1.00, updatedAt: new Date().toISOString() },
  { id: 'm2', accountId: 'acc1', userId: 'u1', ticker: 'VXUS', name: 'Vanguard Total International Stock ETF', assetClass: 'etf',         sector: 'International',          geography: 'International Developed', quantity: 380,  costBasis: 57.95,  currentPrice: 62.80,  currentValue: 23864.00, beta: 0.92, updatedAt: new Date().toISOString() },
  { id: 'm3', accountId: 'acc1', userId: 'u1', ticker: 'BND',  name: 'Vanguard Total Bond Market ETF',       assetClass: 'fixed_income',  sector: 'Bonds',                  geography: 'US',                    quantity: 210,  costBasis: 74.73,  currentPrice: 73.20,  currentValue: 15372.00, beta: 0.05, updatedAt: new Date().toISOString() },
  { id: 'm4', accountId: 'acc1', userId: 'u1', ticker: 'AAPL', name: 'Apple Inc.',                           assetClass: 'equity',        sector: 'Technology',             geography: 'US',                    quantity: 95,   costBasis: 159.65, currentPrice: 192.50, currentValue: 18287.50, beta: 1.24, updatedAt: new Date().toISOString() },
  { id: 'm5', accountId: 'acc1', userId: 'u1', ticker: 'AMZN', name: 'Amazon.com Inc.',                      assetClass: 'equity',        sector: 'Consumer Discretionary', geography: 'US',                    quantity: 52,   costBasis: 212.84, currentPrice: 256.75, currentValue: 13351.00, beta: 1.18, updatedAt: new Date().toISOString() },
  { id: 'm6', accountId: 'acc1', userId: 'u1', ticker: 'NVDA', name: 'NVIDIA Corporation',                   assetClass: 'equity',        sector: 'Technology',             geography: 'US',                    quantity: 40,   costBasis: 410.00, currentPrice: 875.40, currentValue: 35016.00, beta: 1.75, updatedAt: new Date().toISOString() },
  { id: 'm7', accountId: 'acc1', userId: 'u1', ticker: 'JPM',  name: 'JPMorgan Chase & Co.',                 assetClass: 'equity',        sector: 'Financials',             geography: 'US',                    quantity: 65,   costBasis: 145.20, currentPrice: 198.80, currentValue: 12922.00, beta: 1.15, updatedAt: new Date().toISOString() },
  { id: 'm8', accountId: 'acc1', userId: 'u1', ticker: 'GLD',  name: 'SPDR Gold Shares',                     assetClass: 'etf',           sector: 'Commodities',            geography: 'Global',                quantity: 30,   costBasis: 178.50, currentPrice: 215.60, currentValue: 6468.00,  beta: 0.10, updatedAt: new Date().toISOString() },
]
