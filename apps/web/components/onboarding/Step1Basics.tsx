...
export function Step1Basics({ data, onChange, subIndex, onSubAdvance, isMobile }: Props) {
  ...
  // salary, so the LiveProjection sidecar hasn't yet been introduced. Render
  // them centered on the page for a cinematic opener. From the salary
  // question onward, the layout reverts to the standard left-aligned form
  // that lines up with the sidecar slot.
